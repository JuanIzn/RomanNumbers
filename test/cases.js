...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { integerToRomanCases, romanToIntegerCases };
} else {
  window.integerToRomanCases = integerToRomanCases;
  window.romanToIntegerCases = romanToIntegerCases;
}
